...
eventsNewController.$inject = ['Event', '$state', 'filepickerService', '$scope', 'currentUserService', '$rootScope'];

function eventsNewController(Event, $state, filepickerService, $scope, currentUserService, $rootScope) {
  const vm = this;
  vm.event = {
    location: {
      lat: null,
